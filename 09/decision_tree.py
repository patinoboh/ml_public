...
parser.add_argument("--max_depth", default=10, type=int, help="Maximum decision tree depth")
parser.add_argument("--max_leaves", default=10, type=int, help="Maximum number of leaf nodes")
    ...
    def can_split(self, node, depth):
        ...
        return (self._max_depth is None or depth < self._max_depth) and \
               len(node.instances) >= self._min_to_split and \
                (self._max_leaves is None or self._leaves < self._max_leaves) and \
