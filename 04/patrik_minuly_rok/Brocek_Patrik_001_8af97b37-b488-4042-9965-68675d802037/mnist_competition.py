...
def create_model():
    ...
    params ={
        ...
        "algo__alpha":[0.00001,0.0004,0.003]
    }

    return sklearn.model_selection.GridSearchCV(estimator=pipe, cv=cross_valid, param_grid=params, n_jobs=-1, refit=True)
...
def main(args: argparse.Namespace) -> Optional[npt.ArrayLike]:
    if args.predict is None:
        ...
        model = create_model().fit(train.data, train.target)
