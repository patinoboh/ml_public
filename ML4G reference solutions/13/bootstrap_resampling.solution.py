...
def main(args: argparse.Namespace) -> tuple[list[tuple[float, float]], float]:
    ...
    #
    # Notably, estimate the probability that the null hypothesis holds
    ...
    if args.plot:
        ...
        ax.axvline(0, ls="--", color="#f0f", label="{:04.1f}%: 0.0".format(result))
...
if __name__ == "__main__":
    ...
    print("The estimated probability that the null hypothesis holds: {:.2f}%".format(result))
