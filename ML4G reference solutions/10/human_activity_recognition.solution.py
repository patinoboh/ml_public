...
def main(args: argparse.Namespace) -> Optional[npt.ArrayLike]:
    if args.predict is None:
        ...
        # Possible data augmentation of the training data.
        # train.data = np.concatenate([train.data, train.data + 1, train.data - 1], axis=0)
        # train.target = np.concatenate([train.target] * 3, axis=0)
        ...
        model = sklearn.pipeline.Pipeline([
            ...
            ("estimator", {
                ...
                "hgbt": sklearn.ensemble.HistGradientBoostingClassifier(max_iter=args.trees, max_leaf_nodes=20, early_stopping=False, verbose=1),
